...
class MAMBA(nn.Module):
    ...
    def step(self, u, h=None):
        ...
        scores = torch.cat([point1, point2, point3], dim=1)  # (B, 3)
        ...
        K = self.K_proj(u)
        h_new = (dA - dB * K) * h + dB * x  # (B, D_state)
        # 输出计算
